    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gray-800 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4">
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2 bg-gray-700 rounded-md hover:bg-gray-600 transition">
                    ...
                    <li>
                        <a href="#" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 transition">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
