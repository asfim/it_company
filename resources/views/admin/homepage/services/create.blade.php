...
@section('homepage_title', 'Create Service')
...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-2">Add New Service</h2>
</div>

<form action="{{ route('admin.homepage.services.store') }}" method="POST">
    @csrf
    <div class="space-y-6">
        <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="icon" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>

            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Redirect URL/Route (e.g. /services/web-application)</label>
                <input type="text" name="link" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>
        </div>
