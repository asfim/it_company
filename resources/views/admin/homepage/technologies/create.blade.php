...
@section('homepage_title', 'Create Technology')
...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-2">Add New Technology</h2>
</div>

<form action="{{ route('admin.homepage.technologies.store') }}" method="POST">
    @csrf
    <div class="space-y-6">
        <div>
        ...
        <div>
            ...
            <input type="text" name="icon_class" required placeholder="devicon-php-plain colored" class="w-full border border-gray-300 rounded px-3 py-2 focus:ring-blue-500 focus:border-blue-500" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="direction" required class="w-full border border-gray-300 rounded px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                    <option value="left">Top Row (Moves Left)</option>
                    <option value="right">Bottom Row (Moves Right)</option>
                </select>
            </div>
